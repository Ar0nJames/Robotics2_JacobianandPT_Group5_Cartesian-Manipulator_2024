...
q3 = np.array([0,mm_to_meter(float(30)),
                mm_to_meter(float(30)),
                mm_to_meter(float(30)),
                ])
...
q5 = np.array([0,mm_to_meter(float(30)),
                mm_to_meter(float(0)),
                mm_to_meter(float(30)),
                ])
...
q11 = np.array([0,mm_to_meter(float(30)),
                mm_to_meter(float(0)),
                mm_to_meter(float(30)),
                ])
...
tradj11 = rtb.jtraj(q10,q11,50)
tradj12 = rtb.jtraj(q11,q0,50)
...
CARTESIAN.plot(tradj12.q, limits=[x1,x2,y1,y2,z1,z2])
