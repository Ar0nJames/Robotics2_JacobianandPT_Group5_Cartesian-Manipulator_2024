...
def forward():
    ...
    if a1 <0:
        messagebox.showerror(title="Model can't Support Negative Values", message= " a1 is below 0")
    if a2 <0:
        messagebox.showerror(title="Model can't Support Negative Values", message= " a2 is below 0")
    if a3 <0:
        messagebox.showerror(title="Model can't Support Negative Values", message= " a3 is below 0")
    if a4 <0:
        messagebox.showerror(title="Model can't Support Negative Values", message= " a4 is below 0")
...
IK =Button(BF,text="↑Inverse",font=(10),bg="blue", fg="black",command=inverse)
